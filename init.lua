...
local layouts = dofile(obj.spoonPath .. "layouts.lua")
...
local blocklist = dofile(obj.spoonPath .. "blocklist.lua")
...
local windowtab = dofile(obj.spoonPath .. "windowtab.lua")
local untracked = dofile(obj.spoonPath .. "untracked.lua")
...
function obj:start()
  ...
  layouts.start(self.config, modal.getInstance(), workspaces)
  ...
  membership.start(self.config, modal.getInstance(), workspaces, blocklist)
  ...
  untracked.start(self.config, modal.getInstance(), workspaces, virtualdisplay, windowanim, blocklist)
